    ...
    state = {
        ...
        features: [
            ...
            [
                'quetzz.png',
                'Quetzzare',
                'Puoi aiutare gli altri utenti raccomandando il professionista giusto per le loro richieste, e in cambio ottenere dei punti, per portarti a casa i prodotti che ti interessano.'
            ]
        ]
    }

    curveStyles = {zIndex: '-1', maxWidth: '400px'}
    ...
    render() {
        ...
        >
            <PromoHeader
                ...
                callToActionHandler={() => this.props.history.push('/register-user')}
            />
            <div className="relative">
                <div className="container bg-white md:bg-light-gray">
                    <div className="bg-white mb-32 rounded-lg text-center text-24 md:text-32 font-bold text-raleway py-12 md:mb-32 md:py-16" style={{height: '180px', marginTop: '-256px'}}>
                        SU QUETZZ PUOI...
                    </div>
            ...
            <div className="bg-white py-12 px-4 md:pt-24 md:pb-40 md:px-0">
                <div className="container">
                    ...
                    <div className="flex flex-wrap mb-12 md:mb-40 justify-between">
                        <div className="w-full md:flex-12" style={this.isMobile() ? {} : {maxWidth: '522px'}}>
                        ...
                        <div className="w-full md:flex-1" style={this.isMobile() ? {} : {maxWidth: '520px'}}>
                            ...
                            <p className="leading-relaxed text-16 float-left mb-8">
                            Sei pronto a convertire i punti guadagnati nelle gift cards di cui più hai bisogno?
                            </p>
                        </div>
                    </div>
                    <div className="flex justify-center px-16 flex-wrap">
                        {
                            [
                                ...
                                (url, idx) => <div key={`gift-cards-${idx}`} className="mx-4 rounded-lg mb-4" style={{minWidth: '8rem', width: '12rem'}}>
            ...
            <div className="bg-white py-24 px-4 md:px-0">
                <div className="container text-center">
                    ...
                    >
                        Tra vent'anni sarai più deluso dalle cose non hai fatto che da quelle che hai fatto. Perciò molla gli ormeggi, esci dal porto sicuro e
