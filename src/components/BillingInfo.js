...
import {
  createLoaderModal,
  createModal, namePattern,
  namePatternMessage, optional,
...
class BillingInfo extends Component {
  ...
  componentDidMount() {
    ...
    proProfileAPI.getProBillingInfo().then((billingInfo) =>
      this.setState({
        billingInfo: {
          ...billingInfo,
  ...
  save = () => {
    ...
    if (this.form.current.checkValidity()) {
      ...
      createLoaderModal(
        proProfileAPI.putProBillingInfo(dataToSend)
      ).then(() =>
    ...
    return (
      <div className="bg-white md:bg-transparent flex justify-between py-8 px-4 md:px-0">
        ...
        <div className="inline-flex">
          ...
          <span className="inline-flex mr-4 md:mr-8 cursor-pointer border-b-2 border-black">
            <div>
...
export default connect(mapStateToProps)(withRouter(BillingInfo));
